            ...
            <div class="col-md-4 col-md-offset-4">   
                ...
                <div class="panel panel-default">            
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-lock fa-1x"></i> <?php echo $this->config->item('app_name'); ?></h3>                        
                    </div>                    
                    <div class="panel-body">
                        <form role="form" method="post" action="<?php echo site_url(); ?>/index/authenticate">
                            <fieldset>
                                ...
                                <input class="btn btn-lg btn-success btn-block" type="submit" name="btnlogin" value="Login">
                            </fieldset>
                        </form>
                    </div>
                </div>
                [username: <?php echo $this->config->item('app_username'); ?>, password: <?php echo $this->config->item('app_password'); ?>]
            </div>
        </div>
    </div>
